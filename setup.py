...
setup(
    ...
    dependency_links = ['http://github.com/scoursen/django-softdelete/tarball/master#egg=django-softdelete-0.3.4customdownload',],
    setup_requires = ['django-softdelete==0.3.4customdownload'],
